...
namespace LoaderConfig {
    ...
    inline constexpr int kLocalVersion = 17;
    inline constexpr const char* kDisplayVersion = "v1.2.14";
    ...
    inline constexpr const char* kFallbackUsermodeUrl =
        "https://github.com/binx-ux/frontier-releases/releases/download/v1.2.14/Frontier.exe";

...
namespace LoaderConfig {
    ...
    inline constexpr int kLocalVersion = 14;
    inline constexpr const char* kDisplayVersion = "v1.2.11";
    ...
    inline constexpr const char* kFallbackUsermodeUrl =
        "https://github.com/binx-ux/frontier-releases/releases/download/v1.2.11/Frontier.exe";

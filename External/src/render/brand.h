...
namespace Frontier {
    ...
    inline constexpr const char* kTagline = "PREMIUM ROBLOX EXTERNAL";
    inline constexpr const char* kVersion = "v1.2.31";
    ...
    inline constexpr const char* kFooterText = "FRONTIER";
}
